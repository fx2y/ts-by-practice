...
import { Job, JobsList } from "@/features/jobs";
...
const PublicOrganizationPage = ({ organization, jobs }: PublicOrganizationPageProps) => {
  ...
  return (
    <>
      ...
      <Stack spacing="8" w="full" maxW="container.lg" mx="auto" mt="12" p="4">
        <OrganizationInfo organization={organization} />
        <Heading size="md" my="6">Open Jobs</Heading>
...
PublicOrganizationPage.getLayout = (page: ReactElement) => <PublicLayout>{page}</PublicLayout>;
